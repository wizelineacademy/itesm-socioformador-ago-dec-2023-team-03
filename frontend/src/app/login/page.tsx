  ...
  return (
    <div className="h-full">
      <div className="
        ...
        "
      >
        <Box className="h-2/5 w-3/6 text-center py-8 text-3xl rounded-2xl flex flex-col items-center">
